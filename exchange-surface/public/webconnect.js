window.addEventListener('DOMContentLoaded', async function () {
  ...
  console.log('🚀 ~ file: webconnect.js:19 ~ visibilityElements:', visibilityElements);
  ...
  if (visibilityElements && visibilityElements.length) {
    ...
    visibilityElements.forEach((visibilityElem) => {
      ...
      console.log(
        '🚀 ~ file: webconnect.js:37 ~ visibilityElements.forEach ~ visWhenCollectionFrom:',
      ...
      if (visWhenCollectionFrom === 'BROWSER_STORAGE') {
        ...
        console.log(
          '🚀 ~ file: webconnect.js:61 ~ visibilityElements.forEach ~ browserData:',
          browserData,
        );
...
const loadHyperLinkFromBSL = (isModal = false, query = '') => {
  ...
  console.log('🚀 ~ file: webconnect.js:358 ~ loadHyperLinkFromBSL ~ bslElems:', bslElems);
  if (bslElems) {
...
const loadSessionDataIntoElements = (isModal = false, sessionKey = '', query = '') => {
  ...
  console.log('🚀 ~ sessionDataAttributeElems:', sessionAttributes);
...
const loadSessionTenantDataIntoElements = (isModal = false, sessionKey = '', query = '') => {
  ...
  console.log('🚀 ~ sessionDataAttributeElemsForTenant:', sessionAttributes);
  if (sessionAttributes) {
...
const loadSessionUserSettingsDataIntoElements = (isModal = false, sessionKey = '', query = '') => {
  ...
  console.log('🚀 ~ sessionDataAttributeElemsForuserSettings:', sessionAttrElems);
  if (sessionAttrElems) {
...
const loadPreviousActionResponseDataIntoElements = (
  ...
  console.log(
    '🚀 ~ file: webconnect.js:607 ~ loadPreviousActionResponseDataIntoElements bslElems:',
    bslElems,
  );
...
const renderBSLDataIntoElements = (sessionAttrElems, bslKey, bslPath) => {
  console.log(
    '🚀 ~ file: webconnect.js:769 ~ renderBSLDataIntoElements ~ sessionAttrElems:',
    sessionAttrElems,
  );
  ...
  if (sessionAttrElems) {
    sessionAttrElems.forEach((element) => {
      ...
      if (!isParentDataGroup) {
        ...
        console.log(
          '🚀 ~ file: webconnect.js:769 ~ renderBSLDataIntoElements ~ bslKeyValue:',
          bslKeyValue,
        );
        console.log(
          '🚀 ~ file: webconnect.js:769 ~ renderBSLDataIntoElements ~ bslPathValue:',
          bslPathValue,
        );
        let browserStorageData = getBSLData(bslKeyValue);
        console.log(
          '🚀 ~ file: webconnect.js:780 ~ renderBSLDataIntoElements ~ browserStorageData:',
          browserStorageData,
        );
        ...
        console.log(
          '🚀 ~ file: webconnect.js:820 ~ sessionAttrElems.forEach ~ bslDataValue:',
          bslDataValue,
        );
        if (element?.tagName === 'IMG' || element?.tagName === 'IFRAME') {
